  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#0a0a0a]/60 via-[#0a0a0a]/50 to-[#0a0a0a]/60" />
      </div>

      {/* Ambient glow effects */}
      <motion.div
        className="absolute top-20 left-10 w-24 h-24 rounded-full blur-3xl"
        style={{ backgroundColor: `${GREEN_417548}33` }}
        animate={{
          x: [0, 30, 0],
          y: [0, -20, 0],
          scale: [1, 1.1, 1],
      ...
      />
      <motion.div
        className="absolute bottom-40 right-20 w-32 h-32 rounded-full blur-3xl"
        style={{ backgroundColor: `${GREEN_417548}1A` }}
        animate={{
          x: [0, -40, 0],
          y: [0, 30, 0],
          scale: [1, 1.2, 1],
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                Experience the pinnacle of digital banking s where cutting-edge technology meets unparalleled simplicity.
              </motion.p>
            </div>
            ...
            >
              {["Zero Hidden Fees", "60s Account Setup", "24/7 Premium Support"].map((benefit, i) => (
                <motion.div
                  key={benefit}
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              <motion.div
                ...
                style={{ backgroundColor: `${GREEN_417548}4D` }}
                animate={{
        ...
        >
          <motion.div
            ...
            transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut" }}
          >
            <div className="w-5 h-8 border-2 border-gray-400/50 rounded-full flex justify-center pt-1.5">
              <motion.div
                className="w-1 h-2 bg-gray-400/50 rounded-full"
