        ...
        <div className="p-3 md:p-6 flex flex-col flex-1">
          ...
          <div className="flex items-start justify-between mb-2 md:mb-4">
            <div className="flex-1">
              <motion.span
                ...
                style={{
                  ...
                  backgroundColor: `${DARK_GREEN_LIGHT}10`,
                }}
            ...
            <div
              ...
              style={{ backgroundColor: `${DARK_GREEN_LIGHT}10` }}
            >
              <account.icon className="w-3 h-3 md:w-4 md:h-4" style={{ color: DARK_GREEN_LIGHT }} />
            </div>
          </div>

          {/* APY Display */}
          <div className="mb-2 md:mb-4 p-2.5 md:p-4 rounded-lg md:rounded-xl bg-gray-50 border border-gray-100">
            ...
            {account.features.map((feature) => (
              <div key={feature} className="flex items-center gap-1.5 md:gap-2">
                <div
                  ...
                  style={{ backgroundColor: `${DARK_GREEN_LIGHT}15` }}
                >
                  <Check className="w-2 h-2 md:w-2.5 md:h-2.5" style={{ color: DARK_GREEN_LIGHT }} />
                </div>
                <span className="text-[11px] md:text-sm text-gray-600 font-normal">{feature}</span>
              </div>
            ))}
          </div>
          ...
          {/* CTA Button */}
          <motion.button
            className="relative w-full py-2 md:py-3 px-3 md:px-6 rounded-lg md:rounded-xl font-semibold text-xs md:text-sm tracking-wide overflow-hidden group/btn"
            style={{ backgroundColor: account.buttonColor || DARK_GREEN_LIGHT }}
  ...
  return (
    <section id="accounts" className="relative py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Account Cards Grid */}
        <motion.div
          className="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-6 max-w-4xl mx-auto"
