...
const lifestyleImages = [
  ...
  { query: "financial advisor meeting clients modern office", aspect: "landscape" },
  { query: "mobile banking app contactless payment", aspect: "square" },
  { query: "student budgeting laptop coffee shop", aspect: "landscape" },
  { query: "entrepreneur reviewing analytics dashboard office", aspect: "portrait" },
  { query: "family financial planning home table", aspect: "square" },
]

const socialPosts = [
  { handle: "@sarahsaves", text: "Switched to Pennywise and my savings finally grow. No cap 🔥", likes: "2.4k" },
  { handle: "@mikebuilds", text: "Business banking that actually keeps up with my startup.", likes: "1.8k" },
  { handle: "@growthfounder", text: "Finally a bank that doesn't nickel and dime me on fees.", likes: "956" },
]
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <motion.div
                  ...
                  style={{ backgroundColor: `${DARK_GREEN}33` }}
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  <span className="font-bold text-sm" style={{ color: DARK_GREEN_LIGHT }}>
              ...
              <motion.div
                ...
                whileHover={{ color: DARK_GREEN_LIGHT }}
