...
-- ============================================
-- Go to: https://supabase.com/dashboard/project/pxzxexnbnlxqthfymkng
...
-- SUCCESS! 
-- ============================================
-- After running this, new users will get:
-- 1. Default profile image: https://res.cloudinary.com/qz5m8bhg/image/upload/v1785215266/profilr_n29abb.jpg
-- 2. Initial balance: $0.00
-- ============================================